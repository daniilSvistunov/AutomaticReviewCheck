...
// GET
mock.onGet((`${import.meta.env.VITE_ENDPOINT_TASKS}/application-pages/`)).reply(200, mockTasks);
mock.onGet(new RegExp(`${import.meta.env.VITE_ENDPOINT_TASKS}/\\w+`)).reply(200, mockTasks);
